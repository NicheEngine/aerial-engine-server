...
public abstract class ControlService {
    ...
    public EventsTopicResponse<MqttReplyResult<?>> flyToPointProgress(EventsTopicRequest<FlyToPointProgress> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public EventsTopicResponse<MqttReplyResult<?>> takeoffToPointProgress(EventsTopicRequest<TakeoffToPointProgress> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public EventsTopicResponse<MqttReplyResult<?>> drcStatusNotify(EventsTopicRequest<DrcStatusNotify> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public EventsTopicResponse<MqttReplyResult<?>> joystickInvalidNotify(EventsTopicRequest<JoystickInvalidNotify> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public EventsTopicResponse<MqttReplyResult<?>> cameraPhotoTakeProgress(EventsTopicRequest<MqttErrorRequest<CameraPhotoTakeProgress>> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public EventsTopicResponse<MqttReplyResult<?>> poiStatusNotify(EventsTopicRequest<PoiStatusNotify> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public ServicesTopicResponse<MqttErrorRequest<?>> flightAuthorityGrab(GatewayManager gateway) throws AerialMqttErrorException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.FLIGHT_AUTHORITY_GRAB.getMethod());
    }

    @DjisdkVersion(exclude = GatewayThing.REMOTER_CONTROL)
    public ServicesTopicResponse<MqttErrorRequest<?>> payloadAuthorityGrab(GatewayManager gateway, PayloadAuthorityGrabRequest request) throws AerialMqttErrorException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.PAYLOAD_AUTHORITY_GRAB.getMethod(), request);
    }

    @DjisdkVersion(exclude = GatewayThing.REMOTER_CONTROL)
    public ServicesTopicResponse<MqttErrorRequest<?>> drcModeEnter(GatewayManager gateway, DrcModeEnterRequest request) throws AerialMqttErrorException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.DRC_MODE_ENTER.getMethod(), request);
    }

    @DjisdkVersion(exclude = GatewayThing.REMOTER_CONTROL)
    public ServicesTopicResponse<MqttErrorRequest<?>> drcModeExit(GatewayManager gateway) throws AerialMqttErrorException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.DRC_MODE_EXIT.getMethod());
    }

    @DjisdkVersion(exclude = GatewayThing.REMOTER_CONTROL)
    public ServicesTopicResponse<MqttErrorRequest<?>> takeoffToPoint(GatewayManager gateway, TakeoffToPointRequest request) throws AerialMqttErrorException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.TAKEOFF_TO_POINT.getMethod(), request);
    }

    @DjisdkVersion(exclude = GatewayThing.REMOTER_CONTROL)
    public ServicesTopicResponse<MqttErrorRequest<?>> flyToPoint(GatewayManager gateway, FlyToPointRequest request) throws AerialMqttErrorException {
    ...
    public ServicesTopicResponse<MqttErrorRequest<?>> flyToPointUpdate(GatewayManager gateway, FlyToPointUpdateRequest request) throws AerialMqttErrorException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.FLY_TO_POINT_UPDATE.getMethod(), request);
    }

    @DjisdkVersion(exclude = GatewayThing.REMOTER_CONTROL)
    public ServicesTopicResponse<MqttErrorRequest<?>> flyToPointStop(GatewayManager gateway) throws AerialMqttErrorException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.FLY_TO_POINT_STOP.getMethod());
    }

    @DjisdkVersion(since = CloudSdkVersion.V1_0_2, exclude = GatewayThing.REMOTER_CONTROL, include = GatewayThing.DOCK)
    public ServicesTopicResponse<MqttErrorRequest<?>> poiModeEnter(GatewayManager gateway, PoiModeEnterRequest request) throws AerialMqttErrorException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.POI_MODE_ENTER.getMethod(), request);
    }

    @DjisdkVersion(since = CloudSdkVersion.V1_0_2, exclude = GatewayThing.REMOTER_CONTROL, include = GatewayThing.DOCK)
    public ServicesTopicResponse<MqttErrorRequest<?>> poiModeExit(GatewayManager gateway) throws AerialMqttErrorException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.POI_MODE_EXIT.getMethod());
    }

    @DjisdkVersion(since = CloudSdkVersion.V1_0_2, exclude = GatewayThing.REMOTER_CONTROL, include = GatewayThing.DOCK)
    public ServicesTopicResponse<MqttErrorRequest<?>> poiCircleSpeedSet(GatewayManager gateway, PoiCircleSpeedSetRequest request) throws AerialMqttErrorException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.POI_CIRCLE_SPEED_SET.getMethod(), request);
    }

    @DjisdkVersion(exclude = GatewayThing.REMOTER_CONTROL)
    protected void droneControlDown(GatewayManager gateway, DroneControlRequest request) throws AerialMqttErrorException {
    ...
    public void droneControlUp(DrcTopicRequest<DrcUpData<DroneControlResponse>> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    @DjisdkVersion(exclude = GatewayThing.REMOTER_CONTROL)
    public void droneEmergencyStopDown(GatewayManager gateway) throws AerialMqttErrorException {
    ...
    public void droneEmergencyStopUp(DrcTopicRequest<DrcUpData<?>> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    @DjisdkVersion(exclude = GatewayThing.REMOTER_CONTROL)
    public void heartBeatDown(GatewayManager gateway, HeartBeatRequest request) throws AerialMqttErrorException {
    ...
    public void heartBeatUp(DrcTopicRequest<HeartBeatRequest> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public void hsiInfoPush(DrcTopicRequest<HsiInfoPush> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public void delayInfoPush(DrcTopicRequest<DelayInfoPush> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public void osdInfoPush(DrcTopicRequest<OsdInfoPush> request, MessageHeaders headers) throws AerialMqttErrorException {
