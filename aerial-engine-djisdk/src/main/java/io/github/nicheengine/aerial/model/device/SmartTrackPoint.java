...
import io.github.nicheengine.aerial.enums.device.TrackTargetMode;
...
public class SmartTrackPoint extends AerialDjisdkModel {
    private TrackTargetMode trackTargetMode;
