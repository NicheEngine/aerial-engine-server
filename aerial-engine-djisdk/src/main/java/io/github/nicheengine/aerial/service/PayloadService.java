...
public abstract class PayloadService {
    ...
    public ServicesTopicResponse<MqttErrorRequest<?>> payloadControl(GatewayManager gateway, PayloadMethod payloadMethod, AerialDjisdkModel request) throws RestException {
    ...
    public ServicesTopicResponse<MqttErrorRequest<?>> cameraModeSwitch(GatewayManager gateway, CameraModeSwitchRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.CAMERA_MODE_SWITCH.getMethod(), request);
    }

    @DjisdkVersion(exclude = GatewayThing.REMOTER_CONTROL)
    public ServicesTopicResponse<MqttErrorRequest<?>> cameraPhotoTake(GatewayManager gateway, CameraPhotoTakeRequest request) throws RestException {
    ...
    public ServicesTopicResponse<MqttErrorRequest<?>> cameraPhotoStop(GatewayManager gateway, CameraPhotoStopRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.CAMERA_PHOTO_STOP.getMethod(), request);
    }

    @DjisdkVersion(exclude = GatewayThing.REMOTER_CONTROL)
    public ServicesTopicResponse<MqttErrorRequest<?>> cameraRecordingStart(GatewayManager gateway, CameraRecordingStartRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.CAMERA_RECORDING_START.getMethod(), request);
    }

    @DjisdkVersion(exclude = GatewayThing.REMOTER_CONTROL)
    public ServicesTopicResponse<MqttErrorRequest<?>> cameraRecordingStop(GatewayManager gateway, CameraRecordingStopRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.CAMERA_RECORDING_STOP.getMethod(), request);
    }

    @DjisdkVersion(exclude = GatewayThing.REMOTER_CONTROL)
    public ServicesTopicResponse<MqttErrorRequest<?>> cameraAim(GatewayManager gateway, CameraAimRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.CAMERA_AIM.getMethod(), request);
    }

    @DjisdkVersion(exclude = GatewayThing.REMOTER_CONTROL)
    public ServicesTopicResponse<MqttErrorRequest<?>> cameraFocalLengthSet(GatewayManager gateway, CameraFocalLengthSetRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.CAMERA_FOCAL_LENGTH_SET.getMethod(), request);
    }

    @DjisdkVersion(exclude = GatewayThing.REMOTER_CONTROL)
    public ServicesTopicResponse<MqttErrorRequest<?>> cameraScreenDrag(GatewayManager gateway, CameraScreenDragRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.CAMERA_SCREEN_DRAG.getMethod(), request);
    }

    @DjisdkVersion(exclude = GatewayThing.REMOTER_CONTROL)
    public ServicesTopicResponse<MqttErrorRequest<?>> gimbalReset(GatewayManager gateway, GimbalResetRequest request) throws RestException {
    ...
    public ServicesTopicResponse<MqttErrorRequest<?>> cameraLookAt(GatewayManager gateway, CameraLookAtRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.CAMERA_LOOK_AT.getMethod(), request);
    }

    @DjisdkVersion(since = CloudsdkVersion.V1_0_0, exclude = GatewayThing.REMOTER_CONTROL)
    public ServicesTopicResponse<MqttErrorRequest<?>> cameraScreenSplit(GatewayManager gateway, CameraScreenSplitRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.CAMERA_SCREEN_SPLIT.getMethod(), request);
    }

    @DjisdkVersion(since = CloudsdkVersion.V1_0_0, exclude = GatewayThing.REMOTER_CONTROL)
    public ServicesTopicResponse<MqttErrorRequest<?>> photoStorageSet(GatewayManager gateway, PhotoStorageSetRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.PHOTO_STORAGE_SET.getMethod(), request);
    }

    @DjisdkVersion(since = CloudsdkVersion.V1_0_0, exclude = GatewayThing.REMOTER_CONTROL)
    public ServicesTopicResponse<MqttErrorRequest<?>> videoStorageSet(GatewayManager gateway, VideoStorageSetRequest request) throws RestException {
    ...
    public ServicesTopicResponse<MqttErrorRequest<?>> cameraExposureSet(GatewayManager gateway, CameraExposureSetRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.CAMERA_EXPOSURE_SET.getMethod(), request);
    }

    @DjisdkVersion(since = CloudsdkVersion.V1_0_2, include = GatewayThing.DOCK)
    public ServicesTopicResponse<MqttErrorRequest<?>> cameraExposureModeSet(GatewayManager gateway, CameraExposureModeSetRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.CAMERA_EXPOSURE_MODE_SET.getMethod(), request);
    }

    @DjisdkVersion(since = CloudsdkVersion.V1_0_2, include = GatewayThing.DOCK)
    public ServicesTopicResponse<MqttErrorRequest<?>> cameraFocusModeSet(GatewayManager gateway, CameraFocusModeSetRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.CAMERA_FOCUS_MODE_SET.getMethod(), request);
    }

    @DjisdkVersion(since = CloudsdkVersion.V1_0_2, include = GatewayThing.DOCK)
    public ServicesTopicResponse<MqttErrorRequest<?>> cameraFocusValueSet(GatewayManager gateway, CameraFocusValueSetRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.CAMERA_FOCUS_VALUE_SET.getMethod(), request);
    }

    @DjisdkVersion(since = CloudsdkVersion.V1_0_2, include = GatewayThing.DOCK)
    public ServicesTopicResponse<MqttErrorRequest<?>> irMeteringModeSet(GatewayManager gateway, IrMeteringModeSetRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.IR_METERING_MODE_SET.getMethod(), request);
    }

    @DjisdkVersion(since = CloudsdkVersion.V1_0_2, include = GatewayThing.DOCK)
    public ServicesTopicResponse<MqttErrorRequest<?>> irMeteringPointSet(GatewayManager gateway, IrMeteringPointSetRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.IR_METERING_POINT_SET.getMethod(), request);
    }

    @DjisdkVersion(since = CloudsdkVersion.V1_0_2, include = GatewayThing.DOCK)
    public ServicesTopicResponse<MqttErrorRequest<?>> irMeteringAreaSet(GatewayManager gateway, IrMeteringAreaSetRequest request) throws RestException {
        return servicesPublish.publish(gateway.getGatewaySn(), ControlMethod.IR_METERING_AREA_SET.getMethod(), request);
    }

    @DjisdkVersion(since = CloudsdkVersion.V1_0_2, include = GatewayThing.DOCK)
    public ServicesTopicResponse<MqttErrorRequest<?>> cameraPointFocusAction(GatewayManager gateway, CameraPointFocusActionRequest request) throws RestException {
