...
@Component
public class StateTopicService {

    public static final String TOPIC_FORMAT = MqttTopicConstants.THING_MODEL_PRE + MqttTopicConstants.PRODUCT + "%s" + MqttTopicConstants.STATE_SUF;
