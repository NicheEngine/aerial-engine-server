...
public class XmlActionCustomDirName extends XmlActionActuatorFuncParam {
    ...
    @JacksonXmlProperty(localName = "directoryName", namespace = KmzConstants.XMLNS_WPML_VALUE)
    @XmlElement(name = "directoryName", namespace = KmzConstants.XMLNS_WPML_VALUE)
    protected String directoryName;

    public static XmlActionCustomDirName defaultInstance() {
        XmlActionCustomDirName xmlActionActuatorFuncParam = new XmlActionCustomDirName();
