...
import io.github.nicheengine.aerial.enums.wayline.LastPointType;
...
public class ReturnHomeInfo extends AerialDjisdkModel {
    private List<GeographyPoint> plannedPathPoints;
    private LastPointType lastPointType;
