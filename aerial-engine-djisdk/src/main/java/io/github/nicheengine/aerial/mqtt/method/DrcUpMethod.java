package io.github.nicheengine.aerial.mqtt.method;


import com.fasterxml.jackson.annotation.JsonCreator;
import com.fasterxml.jackson.annotation.JsonValue;
import com.fasterxml.jackson.core.type.TypeReference;
import io.github.nicheengine.aerial.mqtt.AerialMqttMethod;
...
public enum DrcUpMethod implements AerialMqttMethod {
    ...
    private final TypeReference<?> item;

    DrcUpMethod(String key, String value, TypeReference<?> typeReference) {
        this.key = key;
        this.value = value;
        this.item = typeReference;
    }

    @Override
    public TypeReference<?>  getItem() {
        return this.item;
    }
