...
public class XmlActionStopRecord extends XmlActionActuatorFuncParam {
    ...
    public static XmlActionStopRecord defaultInstance() {
        XmlActionStopRecord xmlActionActuatorFuncParam = new XmlActionStopRecord();
