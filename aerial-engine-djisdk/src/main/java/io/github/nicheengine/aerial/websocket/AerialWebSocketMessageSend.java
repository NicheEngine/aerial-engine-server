...
@Slf4j
public class AerialWebSocketMessageSend {

    public void sendMessage(AerialWebSocketSession webSocketSession, AerialWebSocketMessageResponse<?> message) throws RestException {
    ...
    public void sendBatch(Collection<AerialWebSocketSession> webSocketSessions, AerialWebSocketMessageResponse<?> message) throws RestException {
