...
public abstract class AirsenseService {
    ...
    public EventsTopicResponse<MqttReplyResult<?>> airsenseWarning(EventsTopicRequest<List<AirsenseWarning>> request, MessageHeaders headers) throws RestException {
