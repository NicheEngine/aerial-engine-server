...
public class XmlActionStartRecord extends XmlActionActuatorFuncParam {
    ...
    public static XmlActionStartRecord defaultInstance() {
        XmlActionStartRecord xmlActionActuatorFuncParam = new XmlActionStartRecord();
