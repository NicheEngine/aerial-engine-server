...
@Getter
public enum ControlMethod implements RestKey<String>{
    ...
    @JsonCreator
    public static ControlMethod parseKey(String key) {
        ControlMethod parsedKey = RestKey.parseKey(ControlMethod.class, key);
        return Optional.ofNullable(parsedKey).orElse(ControlMethod.UNKNOWN);
    }
