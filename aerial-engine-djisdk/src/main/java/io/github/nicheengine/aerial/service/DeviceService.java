...
public class DeviceService {
    ...
    public void osdDock(OsdTopicRequest<OsdDock> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public void osdDockDrone(OsdTopicRequest<OsdDockDrone> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public void osdRemoteControl(OsdTopicRequest<OsdRemoteControl> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public void osdRcDrone(OsdTopicRequest<OsdRcDrone> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public StatusTopicResponse<MqttReplyResult<?>> topoOnline(StatusTopicRequest<UpdateTopo> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public StatusTopicResponse<MqttReplyResult<?>> topoOffline(StatusTopicRequest<UpdateTopo> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public StateTopicResponse<MqttReplyResult<?>> droneWpmzVersion(StateTopicRequest<DroneWpmzVersion> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public StateTopicResponse<MqttReplyResult<?>> droneFirmwareVersion(StateTopicRequest<DroneFirmwareVersion> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public StateTopicResponse<MqttReplyResult<?>> droneLiveCapacity(StateTopicRequest<DroneLiveCapacity> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public StateTopicResponse<MqttReplyResult<?>> droneControlSource(StateTopicRequest<DroneControlSource> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public StateTopicResponse<MqttReplyResult<?>> droneLiveStatus(StateTopicRequest<DroneLiveStatus> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    @ServiceActivator(inputChannel = StateChannels.INBOUND_STATE_DRONE_COMMANDER_FLIGHT_MODE)
    public StateTopicResponse<MqttReplyResult<?>> droneCommanderFlightMode(StateTopicRequest<DroneCommanderFlightMode> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    @ServiceActivator(inputChannel = StateChannels.INBOUND_STATE_DRONE_CURRENT_COMMANDER_FLIGHT_MODE)
    public StateTopicResponse<MqttReplyResult<?>> droneCurrentCommanderFlightMode(StateTopicRequest<DroneCurrentCommanderFlightMode> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    @ServiceActivator(inputChannel = StateChannels.INBOUND_STATE_DRONE_COMMANDER_FLIGHT_HEIGHT)
    public StateTopicResponse<MqttReplyResult<?>> droneCommanderFlightHeight(StateTopicRequest<DroneCommanderFlightHeight> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    @ServiceActivator(inputChannel = StateChannels.INBOUND_STATE_DRONE_COMMANDER_MODE_LOST_ACTION)
    public StateTopicResponse<MqttReplyResult<?>> droneCommanderModeLostAction(StateTopicRequest<DroneCommanderModeLostAction> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    @ServiceActivator(inputChannel = StateChannels.INBOUND_STATE_DRONE_RTH_MODE)
    public StateTopicResponse<MqttReplyResult<?>> droneRthMode(StateTopicRequest<DroneRthMode> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public StateTopicResponse<MqttReplyResult<?>> droneCurrentRthMode(StateTopicRequest<DroneCurrentRthMode> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    @ServiceActivator(inputChannel = StateChannels.INBOUND_STATE_DRONE_DONGLE_INFOS)
    public StateTopicResponse<MqttReplyResult<?>> droneDongleInfos(StateTopicRequest<DroneDongleInfos> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public StateTopicResponse<MqttReplyResult<?>> droneCameraWatermarkSettings(StateTopicRequest<DroneCameraWatermarkSettings> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    @ServiceActivator(inputChannel = StateChannels.INBOUND_STATE_DRONE_OFFLINE_MAP_ENABLE)
    public StateTopicResponse<MqttReplyResult<?>> droneOfflineMapEnable(StateTopicRequest<DroneOfflineMapEnable> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public StateTopicResponse<MqttReplyResult<?>> droneModeCodeReason(StateTopicRequest<DroneModeCodeReason> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public StateTopicResponse<MqttReplyResult<?>> dockThermalSupportedPaletteStyle(StateTopicRequest<DockThermalSupportedPaletteStyle> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public StateTopicResponse<MqttReplyResult<?>> dockSilentMode(StateTopicRequest<DockSilentMode> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public StateTopicResponse<MqttReplyResult<?>> dockWirelessLinkTopo(StateTopicRequest<DockWirelessLinkTopo> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public StateTopicResponse<MqttReplyResult<?>> dockAirTransferEnable(StateTopicRequest<DockAirTransferEnable> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public StateTopicResponse<MqttReplyResult<?>> dockFlysafeDatabaseVersion(StateTopicRequest<DockFlysafeDatabaseVersion> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public void rcPayloadFirmwareVersion(StateTopicRequest<RcPayloadFirmwareVersion> request, MessageHeaders headers) throws AerialMqttErrorException {
    ...
    public void rcCloudControlAuth(StateTopicRequest<RcCloudControlAuth> request, MessageHeaders headers) throws AerialMqttErrorException {
